...
<div class="wrapper">
  ...
  @include('admin.layouts.admin._header')
    <!-- Left side column. contains the logo and sidebar -->
  @include('admin.layouts.admin._sider')
    ...
    <div class="content-wrapper" style="height: 1000px">
        ...
        <!-- Main content -->
    @include('admin.layouts.admin._errors')
{{--引入提示信息--}}
    @include('admin.layouts.admin._msg')
    ...
    <!-- /.content-wrapper -->
@include("admin.layouts.admin._footer")
